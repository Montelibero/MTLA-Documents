>  Этот текст носит исключительно информационный характер, оригинал Пакта на английском языке находится здесь: [VoluntaryistCovenant.en.md](VoluntaryistCovenant.en.md).
