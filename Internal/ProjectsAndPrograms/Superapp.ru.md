...
- Более лёгкий онбординг новичков: человек видит, как устроены услуги «виртуального государства», и может сразу поучаствовать.
...
- Перевести **основные процессы** Ассоциации (голосования, репутацию, финансы, активизм) в единый суперапп.
...
### 5.3. Формализация и поддержка

- Закрепить статус проекта решением Совета или института Монтелиберо, чтобы обеспечить долгосрочное финансирование и административную поддержку.
- При необходимости обновлять **программу супераппа** , которая позволит улучшать систему на регулярной основе с учетом новых требований участников Собрания Ассоциации.
