...
* **OwnershipFull** — счёт, на который указывает тег, принадлежит исходному аккаунту на 95% и более.

* **OwnershipMajority** — счёт, на который указывает тег, принадлежит исходному аккаунту на 25–95%.

* **OwnershipMinority** — счёт, на который указывает тег, принадлежит исходному аккаунту менее чем на 25%.

* **Owner** — счёт, на который указывает тег, владеет исходным аккаунтом на 95% и более.

* **OwnerMajority** — счёт, на который указывает тег, владеет исходным аккаунтом на 25-95%. 

* **OwnerMinority** — счёт, на который указывает тег, владеет исходным аккаунтом менее чем на 25%.

При этом теги Owner и OwnershipFull, а также OwnerMajority и OwnershipMajority являются строго парными, и должны взаимно
