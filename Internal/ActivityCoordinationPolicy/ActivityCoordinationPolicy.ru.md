...
4. **Основные роли и статусы акторов:**
   ...
   b. **Активист** — Активист — волонтёр, входящий и исходящий оборот персональных тайм-токенов которого с МТЛА 
   составляет не менее 12 ТТ за три месяца. Тайм-токен обозначается BSN-тегом TimeTokenCode на основном аккаунте 
