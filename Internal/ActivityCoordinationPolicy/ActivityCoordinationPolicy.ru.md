...
4. **Основные роли и статусы акторов:**
   ...
   b. **Активист** — волонтёр, который каждые три месяца отправляет на счёт МТЛА и получает обратно не менее чем по 12 
   своих персональных тайм-токенов. Тайм-токен обозначается BSN-тегом TimeTokenCode на основном аккаунте 
   участника; отличный от основного аккаунт-эмитент тайм-токена обозначается BSN-тегом TimeTokenIssuer.
...
5. **Основные действия:**
   ...
   требуемые ресурсы и ключевые показатели. На аккаунте программы исходящим BSN-тегом ProgramCoordinator должен быть 
   обозначен её координатор, являющийся её участником и верифицированным участником Ассоциации.
