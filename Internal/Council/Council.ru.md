...
5. Голосование проводится в основном чате Совета или на отдельных специализированных площадках, с использованием
   ...
   согласованию с Секретарём. Вопросы, подготовленные в установленном порядке и прошедшие слушания, могут вноситься на
   голосование инициатором самостоятельно или при содействии любого члена Совета в случае, если они вопреки запросу
   инициатора более двух суток не вносятся на голосование в общем порядке и в поддержку внесения вопроса на голосование
   явно высказалось не менее четверти актуального состава Совета. Вопросы на голосование вносятся на русском и
   английском языках или в формате, легко доступном для автоматического перевода.

   По упрощённой процедуре, без подготовки, в одно слушание, принимаются следующие технические решения:
   ...
   g. внесение изменений в ранее утверждённые программы (по инициативе уполномоченного координатора),
   в том числе: смена счёта программы, добавление или уточнение подпунктов и подразделов, не меняющих принципиально её содержание;

   h. технические транзакции по MTLCrowd при наличии визы ответственного за них лица;

   i. инициативы на основании Соглашения, получившие необходимую поддержку в Собрании.

   e. об открытии линий доверия.

   Вопросы по упрощенной процедуре, касающиеся работы Распределенного Правления, может вносить секретарь Распредленного Правления. При наличии возражений со стороны двух и более советников упрощенная процедура не применяется. 
...
8. Для защиты от злоупотребления техническими вопросами каждый действующий Советник обладает правом мотивированного "вето". Право
реализуется до отправки вопроса в блокчейн через аргументированный комментарии под вопросами с упоминанием секретаря Совета.
При ветировании, вопрос в обязательном порядке переносится на общую процедуру слушаний, даже если формально вопрос соответствует
критериям для рассмотрения по упрощенной процедуре.
