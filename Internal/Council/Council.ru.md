...
1. **Процедура.** Оптимальная последовательность рассмотрения вопросов Советом Ассоциации Монтелиберо включает следующие стадии (подпункты b-e являются обязательными):
     ...
     c. обсуждение вопроса (слушания) и сбор поддержки;
...
3. Внесение вопроса. Вопрос на рассмотрение Совета может вносить любой его член, включая участвующих в нём с правом
   совещательного голоса, при условии, что вносимая инициатива получила поддержку не менее трёх советников с правом
   решающего голоса. Вопрос вносится через Секретаря Совета или непосредственно самим его инициатором с одновременным
   добавлением соответствующей записи в Реестр решений Совета, где указываются следующие обязательные реквизиты:
...
5. Голосование проводится в основном чате Совета или на отдельных специализированных площадках, с использованием
   ...
   По упрощённой процедуре, без слушаний и без сбора поддержки, принимаются следующие технические решения:
